...
prefer to be located, can avoid problems which may arise when family
members pass and are buried without any consideration regarding an
overall plan for the site.

The Grove Cemetery Association is eager to discuss with you (at no cost)
the best way to lay out your plot to satisfy all planned users. With
your input we will create a plot-use diagram for both you and the
cemetery to file for future reference. Feel free to call us for more
